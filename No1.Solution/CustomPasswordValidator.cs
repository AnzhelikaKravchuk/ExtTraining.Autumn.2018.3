...
namespace No1.Solution
{
    ...
    {
        private static readonly Lazy<CustomPasswordValidator> LazyRepository
            = new Lazy<CustomPasswordValidator>(() => new CustomPasswordValidator());

        public static CustomPasswordValidator Instance = LazyRepository.Value;

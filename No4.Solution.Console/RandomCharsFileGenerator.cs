...
namespace No4
{
    ...
    {
        private static readonly  Lazy<RandomCharsFileGenerator> LazyFileGenerator = 
            new Lazy<RandomCharsFileGenerator>(() => new RandomCharsFileGenerator());

        public static RandomCharsFileGenerator Instance => LazyFileGenerator.Value;

        private RandomCharsFileGenerator()
        {
        }
